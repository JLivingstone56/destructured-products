export const structuredProductMakeup = {
    ...
    **Key Points**:
    ...
    SPM3: `With Call options, the risk is limited. The worst case scenario, you dont exercise the option and you lose the fees paid. To balance this, issuers sometimes  will limit the ` +
    ...
    SPM4: `Here you can see, in the left graph, that any increase in the value of the underlying over the length of the deal is 1:1 to the profit we make. However, for the right side, ` +
    ...
    SPM5: `Our first example of capped vs uncapped showed how an issuer can limit profit on the upside. However, issuers also often will add incentives to their call option.` +
